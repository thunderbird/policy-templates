## Enterprise policy descriptions and templates for Thunderbird 139
 ...
 * Windows: [group policy templates](https://github.com/thunderbird/policy-templates/tree/master/docs/templates/release/windows) or [intune](https://support.mozilla.org/kb/managing-firefox-intune)
