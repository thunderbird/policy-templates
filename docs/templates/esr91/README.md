 ...
 * Windows: [group policy templates](https://github.com/thunderbird/policy-templates/tree/master/docs/templates/esr91/windows) or [intune](https://support.mozilla.org/kb/managing-firefox-intune)
